...
import loading from '../../assets/loader/Eclipse-1s-200px.svg'
    ...
    return (
        <div className="animate-pulse rounded-lg mt-5 dark:bg-[#f30b0ba8] bg-[#f4f7fa] w-[420px] md:w-[380px] space-y-4 h-[500px] opacity- flex flex-col items-center justify-center shadow-down shadow-xl">
            ...
            <div className="flex flex-col space-y-3">
                ...
                <Link to={"/author"} className="mx-auto flex items-center space-x-2 p-2 ">
                    <Avatar
                        className="animate-pulse"
                        sx={{ width: 56, height: 56 }}
                    />
                    <div>
                        <div className="animate-pulse w-40 h-10 mb-5 border border-black bg-[#1e293b]">
