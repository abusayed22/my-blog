    ...
    return (
      <>
        <div className="dark:bg-black">
          <div className="w-[80%] h-[60vh] mx-auto bg-[#383737] animate-pulse"></div>
          <br />
          <div className=" flex ">
          ...
          <div>
            ...
            <div className="flex justify-center mt-10">paginations</div>
          </div>
        </div>
      </>
    );
      ...
      <div className="dark:bg-black bg-[#E1D5D9]">
        ...
        <div>
          <img
            src={thumbnail}
            alt={name}
            className="w-[75%] h-[60vh] mx-auto shadow-deep "
          />
        </div>
        <br />
          ...
          <div className="w-[92%] p-5 bg-[#AAABA8] rounded-lg">
            ...
            <div className="w-[40%] mx-auto space-x-4 text-red dark:selection:text-yellow flex justify-around">
              ...
              <div className="flex flex-col">
                <b className="w-40 text-yellow text-xl font-bold text-center">{`${
                  comments?.length
                } ${comments?.length > 0 ? "Comment's" : "Comment"}`}</b>

                <b
                  onClick={toggleHandler}
                  className="w-40 text-blue text-xl font-bold transition text-center cursor-pointer"
                >
                  Write Comment
