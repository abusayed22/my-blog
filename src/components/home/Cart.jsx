      ...
      <div className="rounded-lg mt-5 dark:bg-[#f30b0ba8] bg-[#f4f7fa] w-[420px] space-y-4 h-[500px] opacity- flex flex-col items-center justify-center shadow-down shadow-xl">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="mx-auto">
            <Link to={'/single'} className="border border-white transition hover:border-[#818cf8]  shadow-sm hover:shadow-[#818cf8] hover:shadow-md px-5 py-2 text-blue rounded-md">
              View..
            </Link>
          </div>
          ...
          <div>
            <Link to={'/author'} className="text-lg border-b-2">Author Name</Link>
