  ...
  return (
    <>
      {blogs?.map((s) => (
        <div
          key={s.id}
          className=" hover:scale-105 mt-5 transition rounded-lg dark:bg-[#f30b0ba8] bg-[#ec121f]  h-[340px] md:h-[450px] lg:h-[450px] xl:h-[470px] w-[210px] md:w-[360px] xl:w-[380px]  flex flex-col items-center justify-center shadow-down shadow-xl"
        >
          <img
            src={s.thumbnail}
            alt="test"
