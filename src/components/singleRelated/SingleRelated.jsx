  ...
  if(blogs?.length > 0) {
    if (isLoading) {
      ...
      return (
        <>
          {blogs?.map(s => (
            <div key={s.id} className="hover:scale-105 transition rounded-lg mt-5 dark:bg-[#f30b0ba8] bg-[#f4f7fa] w-[420px] md:w-[380px] space-y-4 h-[500px] opacity- flex flex-col items-center justify-center shadow-down shadow-xl">
